...
产物: dist/ThesisForge-v0.4.0-win64-offline.zip
安全约定：
...
DIST = ROOT / "dist"
PKG = DIST / "ThesisForge-v0.4.0-win64"
RT = PKG / "runtime"
...
def main():
    ...
    (PKG / "使用说明.txt").write_text(
        """毕设工坊 ThesisForge v0.4.0 — Windows 离线整合包
================================================
...
""", encoding="utf-8")
    ...
    # 5. 压缩
    step("压缩为 zip ...")
    zpath = DIST / "ThesisForge-v0.4.0-win64-offline.zip"
    if zpath.exists():
        zpath.unlink()
