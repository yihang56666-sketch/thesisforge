...
ZIP="dist/ThesisForge-v0.2.0-win64-offline.zip"
...
echo "== 3. 创建 Release v0.2.0 并上传安装包 =="
gh release create v0.2.0 "$ZIP" \
  --title "毕设工坊 ThesisForge v0.2.0（含 Windows 离线整合包）" \
  --notes-file packaging/release-notes-v0.2.0.md
