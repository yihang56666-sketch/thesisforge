...
ZIP="dist/ThesisForge-v0.4.0-win64-offline.zip"
EXE="dist/ThesisForge-v0.4.0-win-x64.exe"
...
echo "== 3. 创建 Release v0.4.0 并上传资产 =="
gh release create v0.4.0 "$ZIP" "$EXE" \
  --title "毕设工坊 ThesisForge v0.4.0（Windows 独立 EXE + 离线整合包）" \
  --notes-file packaging/release-notes-v0.4.0.md
