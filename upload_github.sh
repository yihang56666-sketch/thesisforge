...
ZIP="dist/ThesisForge-v0.2.1-win64-offline.zip"
EXE="dist/ThesisForge-v0.2.1-win-x64.exe"
...
echo "== 3. 创建 Release v0.2.1 并上传资产 =="
gh release create v0.2.1 "$ZIP" "$EXE" \
  --title "毕设工坊 ThesisForge v0.2.1（Windows 独立 EXE + 离线整合包）" \
  --notes-file packaging/release-notes-v0.2.1.md
